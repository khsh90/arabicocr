...
def extract_text_from_pdf(pdf_path):
    ...
    text = ''
    custom_config = r'-l ara --psm 6 -c tessedit_char_whitelist=٠١٢٣٤٥٦٧٨٩abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'
    for img in images:
...
def index():
    ...
    <body>
      <div class="container p-4">
        <img src="/static/trismart.png" alt="Trismart Logo" class="logo">
...
def convert():
    ...
    if file and allowed_file(file.filename):
        ...
        try:
            ...
            # Set paragraph direction to RTL and font to Traditional Arabic (safe version)
            try:
                p_format = p.paragraph_format
                p_format.alignment = 3  # Right alignment
                from docx.oxml.ns import qn
                from docx.oxml import OxmlElement
                p_rPr = p._p.get_or_add_pPr()
                ...
                print(f"RTL/font error: {rtl_err}")
